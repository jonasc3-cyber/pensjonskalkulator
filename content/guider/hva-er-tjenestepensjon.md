---
title: "Hva er tjenestepensjon? | OTP, innskudd og ytelse"
description: "Forklaring av tjenestepensjon, OTP, innskuddspensjon og ytelsespensjon — og hvordan du bruker tallene i en pensjonskalkulator uten BankID."
slug: "/guider/hva-er-tjenestepensjon"
---
...
**[Legg inn tjenestepensjon i kalkulatoren →](https://sjekkpensjon.no)** (uten BankID)
...
3. **Egen sparing** (IPS, ASK, fond, bank)
4. Eventuell **AFP**

Mange undervurderer punkt 2 — eller glemmer gamle avtaler fra tidligere jobber. En rask oversikt finner du i [Hvor mye får jeg i pensjon?](/guider/hvor-mye-far-jeg-i-pensjon).
...
1. **Type:** innskudd, ytelse eller hybrid?
2. **Sats:** 2 %, 5 %, 7 % — eller mer med tillegg?
3. **Leverandør:** Storebrand, DNB, Nordea, KLP, osv.
4. **Gamle jobber:** har du pensjonskapitalbevis liggende?
5. **AFP:** er arbeidsplassen med i AFP-ordningen?

[Norsk Pensjon](https://norskpensjon.no) kan hjelpe deg å samle oversikt over private avtaler.

## Hvordan tjenestepensjon brukes i en kalkulator

På [sjekkpensjon.no](https://sjekkpensjon.no) er poenget å estimere **helheten** uten BankID. For tjenestepensjon betyr det typisk at du:
...
- [Nav — Din pensjon](https://www.nav.no/dinpensjon)
...
Selv med god OTP dekker folketrygd + tjenestepensjon ikke alltid ønsket levestandard. Da kommer egen sparing inn — for eksempel IPS eller aksjesparekonto. Se [IPS eller ASK?](/guider/ips-eller-ask) for en 2026-oppdatering av grenser og forskjeller.
...
- Bruk egne tall i [sjekkpensjon.no](https://sjekkpensjon.no) for oversikt, og Nav/leverandør for det offisielle

**[Estimer pensjon med tjenestepensjon — uten innlogging →](https://sjekkpensjon.no)**
